...
const reportMenu: Props[] = [
  { title: 'รายงานวัตถุดิบ', linkUrl: '/report/report-materials' },
  { title: 'รายงานทดสอบก้อนปูน', linkUrl: '' },
];
  ...
  return (
        <div className="flex flex-col min-h-screen w-full items-center justify-between">
          ...
          border-4 border-white drop-shadow-md">
                    <h1 className="text-white text-2xl font-[prompt] font-semibold">รายงาน</h1>
                </div>
